(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['backbone.marionette', 'selectize', 'underscore'], factory);
  } else if (typeof exports !== 'undefined') {
    Marionette = require('backbone.marionette');
    Selectize = require('selectize');
    _ = require('underscore');
    module.exports = factory(Marionette, Selectize, _);
  } else {
    root.SelectizeBehavior = factory(root.Marionette, root.Selectize, root._);
  }
})(this, function (Marionette, Selectize, _) {
  ...
  return Marionette.Behavior.extend({
    ...
    onRender: function() {
      ...
      this.ui.el.selectize(_.extend({
        options: this._getOptions(),
        valueField: 'id',
        labelField: this.getOption('textAttribute'),
        sortField: this.getOption('textAttribute'),
        searchField: this.getOption('textAttribute'),
        render: {
          item: this.getOption('renderItem') || undefined,
          option: this.getOption('renderOption') || undefined
        },
        onChange: function (value) {
          model.set(modelField, value || null);
        }
      }, this.getOption('selectizeOptions')));
